...
* Only json (and json.gz) model formats are supported. Export with `save_model(..., format="json")` or use `cbm2json.py` to convert.
...
- `catboost/libs/model/model.h` — model structs, step node diffs
